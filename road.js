  ...
  function chapterHTML() {
    ...
    if (m) {
      ...
      h += '<div class="divide"></div><div class="road"><span class="lbl">The map</span>' + markSVG(m, x) + '<p class="cap">' + leanTxt + '</p>' +
        '<p class="sub">This shows direction, never rank. We move from glory to glory, and the road is not straight.' + (x ? ' The X is where you said you stand: “' + esc(x.text) + '.”' : "") + '</p></div>';
      if (pt.picker) {
    ...
    } else h += '<div class="divide"></div><div class="road"><span class="lbl">The map</span><p class="sub mapnote">' + esc(mapNote()) + '</p></div>';
