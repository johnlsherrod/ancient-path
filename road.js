...
var TELL = (function () {
  ...
  function readHTML(d) {
    ...
    if (done) h += (d.tail.trim() ? '<p class="his prose-p">' + esc("Today I am camped at " + d.tail.trim()) + '</p>' : "") + '<p class="ours closing">' + esc(d.closes) + '</p><p class="ours lower">' + esc(ROAD.LOWER) + '</p>';
